...
import { PERIOD_LABELS, type Period, type PeriodPreset, resolvePeriod } from "@/lib/ads-period";
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <Select
        value={period.preset}
        onValueChange={(value) =>
          onChange(resolvePeriod(value as PeriodPreset, { start: period.start, end: period.end }))
        }
      >
